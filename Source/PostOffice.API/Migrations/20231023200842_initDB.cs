        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Status = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    zone_description = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppUsers_Pincodes_PincodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sender_name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    sender_pincode = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    sender_address = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    sender_phone = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ...
                    receiver_name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    receiver_pincode = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    receiver_address = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    receiver_phone = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParcelOrder_OrderStatus_order_status",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0d04dce2-969a-435d-bba4-df3f325983dc"), "b063e738-58dc-4a84-93d4-ee038fe24b4d", "Customer role", "customer", "CUSTOMER" },
                    { new Guid("79bd714f-9576-45ba-b5b7-f00649be00de"), "98ad4fbe-7b27-49b5-904b-fa71957165ba", "Employee role", "employee", "EMPLOYEE" },
                    { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "393c861a-0372-4eb0-adf7-7fc545d52033", "Administrator role", "admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "AccessFailedCount", "Address", "ConcurrencyStamp", "Create_date", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "PincodeId", "SecurityStamp", "Status", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
                    { new Guid("49bd714f-9576-45ba-b5b7-f00649be00de"), 0, "70 Cong Hoa, Tan Binh District", "209ee76b-08fa-4b4c-bd27-7a81ff1c6bb0", new DateTime(2021, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "hoanguyen@gmail.com", true, "Nguyen", "Hoa", false, null, "hoanguyen@gmail.com", "HOANG", "AQAAAAEAACcQAAAAEKTJwH+274RH1yzHv5hx1U6IU2JDDERV2bFypKbWUpEDwjqe/JmbigqkOr8+r195gQ==", "0933739406", false, "70000", "", null, false, "hoang" },
                    { new Guid("59bd714f-9576-45ba-b5b7-f00649be00de"), 0, "15 Nguyen Van Dau, Binh Thanh District", "6032c360-db53-4490-bd0b-38ef9da7aad5", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "nguyenphuonghoa0709@gmail.com", true, "Nguyen", "Phuong Hoa", false, null, "nguyenphuonghoa0709@gmail.com", "HOANP", "AQAAAAEAACcQAAAAEKZvnnHz7ppI3/JIAFcvDW9JeUVNMp5PQmbdlKIN7MGXHpsa0VNWgzaV4XqDlBKXNQ==", "0119703946", false, "70000", "", null, false, "hoanp" },
                    { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "150 Cong Hoa, Tan Binh District", "af6cad83-939d-489c-96c5-a8ead33713e9", new DateTime(2019, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "onlinepostofficegroup4@gmail.com", true, "Pham", "Chien", false, null, "onlinepostofficegroup4@gmail.com", "admin", "AQAAAAEAACcQAAAAEFJ6aFZ7IJPAMD+xDaRPp4uhiw6pZ54Vhdi/EVYY35jNPAW18yfYZ3lblF9fngZoGA==", "0950003946", false, "70000", "", null, false, "admin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "2 books, 5 pencils", "birthday presents", 1, 25f, 20f, 2, 0f, 30f, "sender", "Cash", "100 Truong Chinh, Ward 11, Tan Binh District", "lvbay@gmail.com", "Le Van Bay", "097631370", "70000", "40 Nguyen Ba Ngoc, Ward 5, Ba Dinh District", "ttbinh@gmail.com", "Tran Van Quang", "023591330", "40000", 1, 36000f, new Guid("49bd714f-9576-45ba-b5b7-f00649be00de"), 0f });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParcelOrder_order_status",
                table: "ParcelOrder",
                column: "order_status");
