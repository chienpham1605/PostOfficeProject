    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ParcelService>().HasData(
                new ParcelService { service_id = 1, name = "Economy", description = "These services are cost-effective but might take longer for delivery, especially for longer distances.", status = "in bussiness", delivery_time = 3 },
                new ParcelService { service_id = 2, name = "Express", description = "Fast delivery services that promise quick delivery, often within one day or overnight, regardless of distance.", status = "in bussiness", delivery_time = 1 }
                );
